========================================================================
    STATISCHE BIBLIOTHEK: MariusParserLib-Projektübersicht
========================================================================

Dieses MariusParserLib-Bibliotheksprojekt wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre MariusParserLib-Anwendung besteht.


MariusParserLib.vcxproj
...
MariusParserLib.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen MariusParserLib.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
